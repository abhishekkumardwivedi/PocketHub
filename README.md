# Extension
1. Login to github
2. Build service or intent listener to receive word or phrase selection
3. ContextView -> To listen and get the word or phrase and allow to checkin or cash it to delayed checkin
4. Scheduler to fetch checkins and pop on screen time to time
